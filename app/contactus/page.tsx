                  ...
                  <div className="flex  justify-center gap-4 items-center w-full md:w-[400px] p-[20px] border rounded-[20px]">
                    <div>
                      <Image
                        src={instagram}
                        alt="instagram"
                        className="min-w-[24px] md:min-w-[30px] hover:scale-110 duration-150 cursor-pointer"
                      />
                    </div>
                    <div>
                  ...
                  <div className="flex justify-center gap-3 items-center w-full md:w-[400px] p-[20px] border rounded-[20px] ">
                    <div>
                      <Image
                        src={discord}
                        alt="discord"
                        className="min-w-[28px] md:min-w-[34px] hover:scale-110 duration-150 cursor-pointer"
                      />
                    </div>
                    <div>
                      <span className="font-bold hover:underline">
